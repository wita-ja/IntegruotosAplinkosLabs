...
namespace IntegruotuSistemuLaboratorinis1
{
    class Tasks
    {
        ...
        private string menu = "         Menu                \n" +
         "1st task - nth number factorial\n" +
         "2nd task - average of n entered values\n" +
         "3rd task - First five positive odd number squares\n" +
         "4th task - area of shape(rectangular,  triangular  or  trapezoidal) calculation\n" +
         "5th task - identify type of simbol (number/lowercase letter/uppercase letter/non letter\n" +
         "6th task - identify errors in cycle\n" +
         "7th task - output values of y = -2.4 * x^2 + 5 * x - 3 by step 0.5 where x from -2 to 2\n" +
         "8th task - output ASCII codes for a-z\n" +
         "9th task - determine if entered number is prime\n" +
         "10th task - number [1:10] guessing game\n" +
         "11th task - Pi magic\n" +
         "12th task - biggest common divisor of two entered numbers\n" +
         "13th task - count digits number in a string" +
         "14th task - guessing game with Vilnius date";
